...
const PHASE_1_COMPLETIONS = {
  'US-E5-001': { status: 'completed', progress_percent: 100, test_coverage: 100, agent: 'backend-api-builder' },
  'US-E5-002': { status: 'completed', progress_percent: 100, test_coverage: 100, agent: 'backend-api-builder' },
  'US-E5-003': { status: 'completed', progress_percent: 100, test_coverage: 98, agent: 'backend-api-builder' },
  'US-E5-004': { status: 'completed', progress_percent: 100, test_coverage: 96, agent: 'backend-api-builder' },
  'US-E5-005': { status: 'completed', progress_percent: 100, test_coverage: 97, agent: 'backend-api-builder' },
  'US-E5-006': { status: 'completed', progress_percent: 100, test_coverage: 100, agent: 'technical-docs-writer' }
};
