...
console.log(
  `📈 Phase 2 Progress: ${phase2Completed}/7 stories complete (${Math.round((phase2Completed / 7) * 100)}%)`
);
...
console.log(
  `📈 Epic 004 Overall: ${epic004Completed}/${epic004Stories.length} stories complete (${Math.round((epic004Completed / epic004Stories.length) * 100)}%)`
);
