...
const Profile: React.FC = () => {
  ...
  const handleExportNostrKeys = () => {
    if (!user.nostr_pubkey) {
      toast.error('No NOSTR keys to export. Connect NOSTR first.');
      return;
    }
    const keysData = {
      publicKey: user.nostr_pubkey,
    ...
    a.href = url;
    a.download = 'sovren-nostr-keys.json';
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
    URL.revokeObjectURL(url);
    toast.success('NOSTR keys exported successfully');
  };
    ...
    <div className='max-w-4xl mx-auto px-4 py-8'>
            ...
            <div className='space-y-4'>
              ...
              <div className='bg-purple-500/10 border border-purple-500/20 rounded-lg p-4'>
                ...
                <Button
                  variant='outline'
                  className='text-sm'
                  onClick={() => navigate('/onboarding/nostr')}
                >
                  Connect NOSTR Keys
                </Button>
              </div>
            ...
            <div className='space-y-4'>
              ...
              <div className='bg-purple-500/10 border border-purple-500/20 rounded-lg p-4'>
                ...
                <Button
                  variant='outline'
                  className='text-sm'
                  onClick={() => toast('Role upgrade coming soon', { icon: '🚀' })}
                >
                  Upgrade to Creator
                </Button>
              </div>
      ...
      <div className='glass rounded-lg p-6 mt-6'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
          ...
          <Button variant='outline' onClick={handleExportNostrKeys}>
            Export NOSTR Keys
          </Button>
        </div>
      </div>
