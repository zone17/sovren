    ...
    <div className='max-w-3xl mx-auto space-y-8'>
      ...
      <section aria-labelledby='profile-heading'>
        <div className='glass-dark rounded-2xl border border-white/5 p-6 sm:p-8'>
          <h2 id='profile-heading' className='text-xl font-semibold text-foreground mb-6'>
            Profile
          </h2>
      ...
      <section aria-labelledby='wallet-heading'>
        <div className='glass-dark rounded-2xl border border-white/5 p-6 sm:p-8'>
          <h2 id='wallet-heading' className='text-xl font-semibold text-foreground mb-6'>
            Wallet Configuration
          </h2>
          <div className='space-y-4'>
            <div className='flex items-center justify-between p-4 rounded-lg bg-white/[0.02] border border-white/5'>
              ...
              <span
                className={`text-xs px-2.5 py-1 rounded-full ${user?.nostr_pubkey ? 'bg-green-500/10 text-green-400 border border-green-500/20' : 'bg-yellow-500/10 text-yellow-400 border border-yellow-500/20'}`}
              >
      ...
      <section aria-labelledby='notifications-heading'>
        <div className='glass-dark rounded-2xl border border-white/5 p-6 sm:p-8'>
          <h2 id='notifications-heading' className='text-xl font-semibold text-foreground mb-6'>
            Notifications
          </h2>
          <div className='space-y-4'>
            ...
            <label className='flex items-center justify-between p-4 rounded-lg bg-white/[0.02] border border-white/5 cursor-pointer'>
              <div>
                ...
                <p className='text-xs text-muted-foreground mt-1'>
                  Get notified when you receive sats
                </p>
              </div>
              <input
                type='checkbox'
            ...
            <label className='flex items-center justify-between p-4 rounded-lg bg-white/[0.02] border border-white/5 cursor-pointer'>
              <div>
                ...
                <p className='text-xs text-muted-foreground mt-1'>
                  Updates on new posts from creators you follow
                </p>
              </div>
              <input
                type='checkbox'
