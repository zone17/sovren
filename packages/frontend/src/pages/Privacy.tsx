        ...
        <article className='prose prose-invert max-w-none'>
          ...
          <section className='space-y-6 text-white/80 leading-relaxed'>
            ...
            <div>
              ...
              <p className='mt-3'>
                <strong>Data we do NOT collect or store:</strong>
              </p>
              <ul className='list-disc pl-6 mt-2 space-y-1'>
            ...
            <div>
              <h2 className='text-xl font-semibold text-foreground mb-3'>
                4. NOSTR Protocol and Decentralization
              </h2>
              <p>
                Content published via NOSTR is distributed across multiple relays and cannot be
                fully removed from the network once published. This is a fundamental property of the
                NOSTR protocol and is by design. Please consider this before publishing content.
              </p>
            </div>
