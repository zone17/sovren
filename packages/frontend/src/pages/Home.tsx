  ...
  return (
    ...
    >
        ...
        <div className='max-w-7xl mx-auto px-6 py-4'>
          <div className='glass-dark rounded-2xl px-6 py-3 flex items-center justify-between'>
            ...
            <div className='hidden md:flex items-center gap-8'>
              <a
                href='#features'
                className='text-sm text-white/60 hover:text-white transition-colors no-underline py-3'
              >
                Features
              </a>
              <a
      ...
      <main>
        ...
        {/* ═══════════════════ WHY SOVREN ═══════════════════ */}
        <section ref={comparisonSection.ref} className='py-24 sm:py-32 relative'>
          <div className='max-w-5xl mx-auto px-4 sm:px-6'>
            <div
              className={`text-center mb-16 transition-all duration-700 ${comparisonSection.inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            >
              <h2
                className='text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4'
                style={{ fontFamily: "'Sora', sans-serif" }}
              ...
              <p className='text-lg text-white/60 max-w-2xl mx-auto'>
                See how Sovren stacks up against the platforms holding creators back.
              </p>
            </div>
                    ...
                    <thead>
                      <tr className='border-b border-white/5'>
                        ...
                        <th className='text-center px-6 py-4'>
                          <span className='text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-purple-400 font-bold text-base'>
                            Sovren
                          </span>
                        </th>
                        <th className='text-center text-white/60 font-medium px-6 py-4'>Patreon</th>
                        <th className='text-center text-white/60 font-medium px-6 py-4'>YouTube</th>
                        <th className='text-center text-white/60 font-medium px-6 py-4'>
                          Substack
                        </th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
                        ...
                        },
                        {
                          ...
                          sovren: 'You own it',
                          patreon: 'Platform owns',
                          youtube: 'Platform owns',
                          substack: 'Platform owns',
                        },
                        {
                          feature: 'Can be Deplatformed',
                          sovren: 'No',
                          patreon: 'Yes',
                          youtube: 'Yes',
                          substack: 'Yes',
                        ...
                        <tr key={row.feature} className={i < 4 ? 'border-b border-white/5' : ''}>
                          <td className='text-white/80 font-medium px-6 py-4'>{row.feature}</td>
                          ...
                          <td className='text-center text-white/40 px-6 py-4'>{row.patreon}</td>
                          <td className='text-center text-white/40 px-6 py-4'>{row.youtube}</td>
                          <td className='text-center text-white/40 px-6 py-4'>{row.substack}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
                  ...
                  {[
                    {
                      feature: 'Platform Fee',
                      sovren: '0%',
                      others: 'Patreon 5-12% / YouTube 30% / Substack 10%',
                    },
                    {
                      feature: 'Payout Speed',
                      sovren: 'Instant',
                      others: 'Others: 30 days',
                    },
                    {
                      feature: 'Content Ownership',
                      sovren: 'You own it',
                      others: 'Others: Platform owns',
                    },
                    {
                      feature: 'Can be Deplatformed',
                      sovren: 'No',
                    ...
                    },
                    {
                      feature: 'Audience Portability',
                      sovren: 'Full (NOSTR)',
                      others: 'Patreon/YouTube: None / Substack: Email only',
                    },
                  ].map(row => (
                    <div key={row.feature} className='px-5 py-4'>
                      ...
                      <p className='text-purple-300 font-semibold flex items-center gap-1.5 mb-1'>
                        <svg
                      ...
                      <p className='text-xs text-white/40'>{row.others}</p>
                    </div>
                  ))}
                </div>
              </div>
      ...
      {/* ═══════════════════ FOOTER ═══════════════════ */}
      <footer aria-label='Site footer' className='border-t border-white/5 pt-16 pb-8'>
