        ...
        >
          ...
          <p className='text-lg sm:text-xl text-white/70 max-w-2xl mx-auto mb-10 leading-relaxed'>
            ...
            <span
              ...
              title='NOSTR is a new way to publish online where no company can delete your content or ban your account.'
            >
              NOSTR
            </span>
                        ...
                        <p className='text-xs text-amber-400/60'>
                          ...
                          {stat.unit === 'sats' && (
                            <span
                              ...
                              title='Sats (satoshis) are the smallest unit of Bitcoin. 100,000 sats is roughly $1 USD.'
                            >
                              (~$0.21 USD)
                            </span>
                          )}
            ...
            <table className='w-full text-sm'>
              <thead>
                <tr className='border-b border-white/5'>
                  ...
                  <th className='text-center py-4 px-4 text-white/40 font-medium hidden sm:table-cell'>
                    Substack
                  </th>
                </tr>
              </thead>
      ...
      <footer className='border-t border-white/5 py-8'>
        <div className='max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4'>
          ...
          <div className='flex items-center gap-6 text-xs text-white/60'>
            <a href='/terms' className='hover:text-white/80 transition-colors no-underline'>
              Terms
            </a>
            <a href='/privacy' className='hover:text-white/80 transition-colors no-underline'>
              Privacy
            </a>
            <a href='/help' className='hover:text-white/80 transition-colors no-underline'>
              Help
            </a>
          </div>
        </div>
