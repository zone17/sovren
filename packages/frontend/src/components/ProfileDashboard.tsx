...
const ProfileDashboard: React.FC = () => {
  ...
  const handleShareProfile = async () => {
    if (!profile) return;
    const profileUrl = window.location.origin + '/creator/' + profile.nostrKeys.pubkey;
    try {
            ...
            <CardContent>
              <div className='flex items-center justify-between'>
                ...
                <Button
                  variant='outline'
                  size='sm'
                  onClick={() => toast('Role switching coming soon', { icon: '🔄' })}
                >
            ...
            <CardContent className='space-y-4'>
              ...
              <div className='flex space-x-4'>
                <Button
                  ...
                  className='flex-1'
                  onClick={() =>
                    window.open('https://njump.me/' + profile.nostrKeys.npub, '_blank')
                  }
                >
            ...
            <CardContent>
              {profile.lightningWallet ? (
                    ...
                    <div className='mt-6 p-4 bg-gradient-to-r from-lightning-500/10 to-sovereign-500/10 rounded-lg border border-lightning-500/20'>
                      ...
                      <div className='grid grid-cols-2 gap-4'>
                        <Button
                          variant='outline'
                          size='sm'
                          onClick={() => toast('Payment links coming soon', { icon: '🔗' })}
                        >
                          Payment Links
                        </Button>
                        <Button
                        ...
                        <Button
                          variant='outline'
                          size='sm'
                          onClick={() => toast('Fan funding coming soon', { icon: '💜' })}
                        >
                          Fan Funding
                        </Button>
                        <Button
                          variant='outline'
                          size='sm'
                          onClick={() => toast('Instant tips coming soon', { icon: '⚡' })}
                        >
                          Instant Tips
                        </Button>
                      </div>
                ...
                <div className='text-center py-8'>
                  ...
                  <Button
                    className='bg-lightning-500 hover:bg-lightning-600'
                    onClick={() => navigate('/onboarding/lightning')}
                  >
          ...
          <Card className='bg-card/50 backdrop-blur-sm border-border/50'>
            ...
            <CardContent>
              <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
                <Button variant='outline' className='h-20 flex-col' onClick={handleShareProfile}>
                ...
                <Button
                  variant='outline'
                  className='h-20 flex-col'
                  onClick={() => toast('Test payments coming soon', { icon: '⚡' })}
                >
