...
const navItems: NavItem[] = [
  { path: '/dashboard', label: 'Dashboard', icon: <DashboardIcon />, creatorOnly: true },
  { path: '/create', label: 'Create', icon: <CreateIcon />, creatorOnly: true },
  { path: '/discover', label: 'Discover', icon: <DiscoverIcon /> },
  { path: '/community', label: 'Community', icon: <CommunityIcon />, creatorOnly: true },
  { path: '/wellness', label: 'Wellness', icon: <WellnessIcon />, creatorOnly: true },
  { path: '/shield', label: 'Shield', icon: <ShieldIcon />, creatorOnly: true },
  { path: '/business', label: 'Business', icon: <BusinessIcon />, creatorOnly: true },
  { path: '/settings', label: 'Settings', icon: <SettingsIcon /> },
  { path: '/monitoring', label: 'Admin', icon: <AdminIcon />, adminOnly: true },
];
        ...
        >
          ...
          <div className='flex items-center gap-3 px-4 h-16 border-b border-white/5'>
            <Link to='/' className='flex items-center gap-2 no-underline'>
              <div className='w-8 h-8 rounded-lg bg-gradient-to-br from-violet-600 to-purple-600 flex items-center justify-center text-white font-bold text-sm shrink-0 font-display'>
                S
              </div>
              {!sidebarCollapsed && (
                <span className='text-sm font-semibold text-foreground font-display'>Sovren</span>
              )}
            </Link>
          </div>
        ...
        >
          <div className='flex items-center justify-between h-14 px-4'>
            <div className='flex items-center gap-3'>
              ...
              <Link to='/' className='flex items-center gap-2 no-underline'>
                <div className='w-7 h-7 rounded-lg bg-gradient-to-br from-violet-600 to-purple-600 flex items-center justify-center text-white font-bold text-xs font-display'>
                  S
                </div>
                <span className='text-sm font-semibold text-foreground font-display'>Sovren</span>
              </Link>
                ...
                {isAuthenticated ? (
                  ...
                  <>
                    <Link
                      to='/#features'
                      onClick={() => setMobileMenuOpen(false)}
                      className='flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium no-underline text-white/40 hover:text-white/80'
                    >
                      <span>Features</span>
                    </Link>
                    <Link
                    ...
                    <div className='border-t border-white/5 mt-4 pt-4 space-y-1'>
                      ...
                      <Link
                        to='/signup'
                        onClick={() => setMobileMenuOpen(false)}
                        className='flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium no-underline text-white bg-gradient-to-r from-violet-600 to-purple-600'
                      >
                        <span>Sign Up</span>
                      </Link>
                    </div>
