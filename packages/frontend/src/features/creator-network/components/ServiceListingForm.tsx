...
const ServiceListingForm: React.FC<ServiceListingFormProps> = ({ onSuccess, onCancel }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4" aria-label="Create service listing">
      <div>
        <label className="block text-sm font-medium text-foreground mb-1" htmlFor="serviceType">
          Service type
        </label>
        <select
          id="serviceType"
      ...
      <div>
        <label className="block text-sm font-medium text-foreground mb-1" htmlFor="priceSats">
          Price (sats)
        </label>
        <input
          id="priceSats"
      ...
      <div>
        <label className="block text-sm font-medium text-foreground mb-1" htmlFor="portfolioUrls">
