...
describe('RevenueSplitEditor', () => {
  describe('Rendering', () => {
    it('renders the Revenue Split heading', () => {
      render(<RevenueSplitEditor entries={splitEntries} onChange={vi.fn()} />);
    ...
    it('does not show Remove buttons when disabled', () => {
      render(<RevenueSplitEditor entries={splitEntries} onChange={vi.fn()} disabled />);
    ...
    it('does not render split preview section when entries are empty', () => {
      render(<RevenueSplitEditor entries={[]} onChange={vi.fn()} />);
    ...
    it('shows creator ID in preview as fallback when no displayName', () => {
      ...
      render(<RevenueSplitEditor entries={entries} onChange={vi.fn()} />);
  ...
  describe('Validation status display', () => {
    it('shows Valid status when bps sums to exactly 10000', () => {
      render(<RevenueSplitEditor entries={singleEntry} onChange={vi.fn()} />);
    ...
    it('shows Does not sum to 100% when bps is under 10000', () => {
      ...
      render(<RevenueSplitEditor entries={invalidEntries} onChange={vi.fn()} previewSats={0} />);
    ...
    it('shows Exceeds 100% when bps exceeds 10000', () => {
      render(<RevenueSplitEditor entries={exceededEntries} onChange={vi.fn()} previewSats={0} />);
