 ...
 * FeedFilters Component
 */
export const FeedFilters = memo<FeedFiltersProps>(
  ({ filters, onChange, className = '' }) => {
    ...
    const handleAddHashtag = (e: React.FormEvent) => {
      ...
      const cleanTag = hashtagInput.startsWith('#')
        ? hashtagInput.substring(1)
        : hashtagInput;
    ...
    return (
      <div className={`feed-filters border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 ${className}`}>
