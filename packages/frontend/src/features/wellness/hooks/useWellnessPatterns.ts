...
export function useWellnessPatterns(period: PatternPeriod = '7d', options?: { enabled?: boolean }) {
  return useQuery({
...
export function useWellnessHeatmap(period: HeatmapPeriod = '7d', options?: { enabled?: boolean }) {
  return useQuery({
