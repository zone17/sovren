...
- [x] No `[class*=...]` selectors in POM files
- [x] All POM locators are used in at least one test assertion
...
| 2026-02-24 | Fixed: removed 7 CSS class locators | Kept heading, subheading, pulseCheckInButton (role-based). When tests need sub-component locators, add role-based or data-testid locators. |
