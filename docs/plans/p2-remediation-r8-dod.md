...
**Wave 2 -- API Consistency (ordered)**:
6. Todo 121 (auth error handler) -- must be before 122
7. Todo 122 (response envelope) -- must be before 119/120

**Wave 3 -- API Expansion (uses envelope from 122)**:
8. Todo 119 (user relationship API)
9. Todo 120 (payment API gaps)

**Wave 4 -- Performance/Architecture**:
10. Todo 123 (payment file corruption)
11. Todo 124 (unbounded caches)
12. Todo 127 (dual DI system)
