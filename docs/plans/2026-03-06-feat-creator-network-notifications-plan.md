...
interface INotificationPersistenceService {
  ...
  list(userId: string, opts: { page: number; limit: number; unreadOnly?: boolean }): Promise<PaginatedResult>;
...
export type CommunityEventPayload =
  ...
  | { type: 'circle_post'; circleId: string; authorId: string; memberIds: string[]; postId: string };
```
