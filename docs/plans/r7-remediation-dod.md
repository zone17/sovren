...
**Wave 2 — P2 Data/Performance**:
4. Todo 138 (fsync) — must be before 140
5. Todo 140 (async I/O) — coordinates with 138
6. Todo 139 (cache stampede) — independent
7. Todo 141 (middleware ordering) — independent

**Wave 3 — P2 Infrastructure**:
8. Todo 142 (EventEmitter cleanup) — independent
9. Todo 143 (NOSTR replay) — independent
10. Todo 144 (compensating transactions) — independent

**Wave 4 — P3 Cleanup (if time permits)**:
11. Todo 149 (z.any validators) — small, high value
12. Todo 148 (dead code) — incremental
13. Todo 147 (circular deps) — scoped
