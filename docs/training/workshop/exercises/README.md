...
5. **05-form-draft**: Manage form drafts with Redux
8. **08-prefetching**: Implement data prefetching

### 🔴 Advanced (30-45 minutes each)
3. **03-dependent-queries**: Chain dependent API calls
6. **06-real-time**: WebSocket + React Query integration
9. **09-full-feature**: Build a complete feature
